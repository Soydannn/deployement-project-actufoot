...
<body class="bg-gray-100 text-gray-900">
    ...
    <main class="max-w-6xl mx-auto p-6">
      ...
      <div class="flex justify-between mt-8">
        <a href="{{ route('palmares') }}" class="text-black-600 hover:underline">← Palmarès</a>
        <a href="{{ route('videos') }}" class="text-bkack-600 hover:underline">Vidéos →</a>
    </div>
    </main>
    ...
    <footer class="bg-white shadow mt-16">
      <div class="max-w-4xl mx-auto px-6 py-10 text-center text-gray-700 flex flex-col items-center">
        ...
        <div class="flex flex-wrap justify-center gap-6 text-sm mb-6">
          ...
          <a href="{{ route('nations') }}" class="hover:underline font-bold">Ligue des Nations</a>
