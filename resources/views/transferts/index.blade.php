...
<body class="bg-gray-100 text-gray-900">
    ...
    <main class="max-w-6xl mx-auto p-6">
      ...
      <div class="flex justify-between mt-8">
        <a href="{{ route('actualites.index') }}" class="text-black-600 hover:underline">← Actualités</a>
        <a href="{{ route('championsleague.index') }}" class="text-bkack-600 hover:underline">Ligues des Champions →</a>
    </div>
    </main>
    <!-- Footer -->
