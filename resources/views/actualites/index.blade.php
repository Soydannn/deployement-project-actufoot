...
<body class="bg-gray-100 text-gray-900">
    ...
    <header class="bg-white shadow p-6 text-center">
        ...
        <nav class="mt-4 space-x-6">
            <a href="{{ route('actualites.index') }}" class="text-green-600 font-sans uppercase font-bold">ACTUALITÉS</a>
            ...
            <a href="{{ route('videos.index') }}" class="text-black hover:text-green-600  font-sans uppercase">VIDÉOS</a>
        </nav>
    ...
    <main class="max-w-6xl mx-auto p-6">
        ...
        <a class="text-green-600  px-4 py-2 rounded hover:underline" href="{{ route('championsleague.show', ['id' => $lastArticle->id]) }}">En savoir plus</a>                    
    </div>
</section>
@endif
        ...
        <section class="max-w-6xl mx-auto px-4 py-8 bg-white rounded shadow mt-8">
            ...
            <a href="{{ route('transferts.index') }}" class="text-green-600 hover:underline text-sm">Voir tout →</a>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach ($transferts as $transfert)
                    <div class="bg-white border border-gray-300 rounded p-4 shadow hover:shadow-lg transition">
                        ...
                        <a class="text-green-600  px-4 py-2 rounded hover:underline" href="{{ route('transferts.show', ['id' => $transfert->id]) }}">En savoir plus</a>                    
                      </div>
                @endforeach
            </div>
        </section>
      ...
      <section class="max-w-6xl mx-auto px-4 py-8 bg-white rounded shadow mt-8">
       ...
       <a href="{{ route('championsleague.index') }}" class="text-green-600 hover:underline text-sm">Voir tout →</a>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            @foreach ($champions as $champion)
              ...
              <a class="text-green-600  px-4 py-2 rounded hover:underline" href="{{ route('championsleague.show', ['id' => $champion->id]) }}">En savoir plus</a>                    
            </div>
          @endforeach
        </div>
      </section>
      ...
      <!-- Les dernières infos concernant le Palmarès -->
        <section class="max-w-6xl mx-auto px-4 py-8 bg-white rounded shadow mt-8">
          ...
          <a href="{{ route('palmares.index') }}" class="text-green-600 hover:underline text-sm">Voir tout →</a>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section class="max-w-6xl mx-auto px-4 py-8 bg-white rounded shadow mt-8">
          ...
          <a href="{{ route('nationsleague.index') }}" class="text-green-600 hover:underline text-sm">Voir tout →</a>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="border border-gray-300 rounded p-4 shadow hover:shadow-lg transition">
                ...
                <a class="text-green-600  px-4 py-2 rounded hover:underline" href="{{ route('nationsleague.show', ['id' => $nation->id]) }}">En savoir plus</a>                    
            </div>
        @endforeach
          </div>
        </section>
     ...
     <section class="max-w-6xl mx-auto px-4 py-8 bg-white rounded shadow mt-8">
      ...
      <a href="{{ route('videos.index') }}" class="text-green-600 hover:underline text-sm">Voir tout →</a>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
  ...
  <div class="flex justify-between mt-8">
    <span></span> 
    <a href="{{ route('transferts.index') }}" class="text-black-600 hover:underline">Transferts →</a>
</div>
</main>
                      <!-- Footer -->
      <footer class="bg-white shadow mt-16">
        <div class="max-w-4xl mx-auto px-6 py-10 text-center text-gray-700 flex flex-col items-center">
          ...
          <div class="flex flex-wrap justify-center gap-6 text-sm mb-6">
            <a href="{{ route('actualites.index') }}" class="hover:underline font-bold">Actualités</a>
            ...
            <a href="{{ route('videos.index') }}" class="hover:underline">Vidéos</a>
          </div>
