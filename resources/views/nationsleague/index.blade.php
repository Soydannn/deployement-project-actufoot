...
<head>
    <meta charset="UTF-8" />
    <title>Ligues des nations - ActuFoot360</title>
...
<body class="bg-gray-100 text-gray-900">
    ...
    <header class="bg-white shadow p-6 text-center">
        ...
        <nav class="mt-4 space-x-6">
            ...
            <a href="{{ route('nationsleague.index') }}" class="text-green-600 font-sans uppercase font-bold">LIGUE DES NATIONS</a>
    ...
    <main class="max-w-6xl mx-auto p-6">
       ...
       <section class="max-w-6xl mx-auto px-4 py-8 bg-white rounded shadow mt-8">
        <h2 class="text-2xl font-semibold text-black-600 mb-6">Bienvenue dans la page concernant les actualités de la League des nations </h2>
      ...
      <div class="flex justify-between mt-8">
        <a href="{{ route('palmares.index') }}" class="text-black-600 hover:underline">← Palmarès</a>
        <a href="{{ route('videos.index') }}" class="text-bkack-600 hover:underline">Vidéos →</a>
    </div>
    </main>
    ...
    <footer class="bg-white shadow mt-16">
      <div class="max-w-4xl mx-auto px-6 py-10 text-center text-gray-700 flex flex-col items-center">
        ...
        <div class="flex flex-wrap justify-center gap-6 text-sm mb-6">
          ...
          <a href="{{ route('nationsleague.index') }}" class="hover:underline font-bold">Ligue des Nations</a>
