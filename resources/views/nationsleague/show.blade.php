...
<body class="bg-gray-100 text-gray-900">
    ...
    <main class="max-w-4xl mx-auto mt-10 p-6 bg-white rounded shadow">
        ...
        @if ($nations->image)
            <img src="{{ $nations->image }}" alt="Image du transfert" class="w-full h-full object-cover mb-4 rounded">
        @endif
        ...
        <div class="mt-8">
            <a href="{{ route('nationsleague.index') }}" class="text-black-600 hover:underline text-sm">← Retour aux actualités concernant la Leagues des nations</a>
        </div>
    </main>
